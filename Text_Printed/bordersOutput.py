...
NO_TERTIARY_BORDERS = " doesn't have any tertiary borders"
ONE_TERTIARY_BORDERS = "'s tertiary border nation is: "
MULTIPLE_TERTIARY_BORDERS = "'s tertiary border nations are: "

BORDER_EACH_OTHER = "Yes, {c1} and {c2} border each other\n"
SECONDARY_BORDER_EACH_OTHER = "{c1} and {c2} are seperated by 1 country\n"
TERTIARY_BORDER_EACH_OTHER = "{c1} and {c2} are seperated by 2 countries\n"
QUATERNARY_BORDER_EACH_OTHER = "{c1} and {c2} are seperated by 3 countries\n"
